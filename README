# Asychronous Demo with Play! Framework 2 
...
3. Change line 26 of application.conf ( https://github.com/mbseid/PlayIntro/blob/master/conf/application.conf ) to have the username/password of your postgresql acount
	* Example: username: test, password: testpassword, database: playintro would be = "postgres://test:testpasswrod@localhost/playintro"


Thats it!  Wasn't that easy.
